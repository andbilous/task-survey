    ...
    <div style={{ backgroundColor: "#fff",marginTop: "15rem" }}>
      ...
      <form>
        <div id='1' style={{marginTop: '2rem', border: '1px solid black', display:'flex',flexDirection:'column'}} className="radio">
            <label><input onClick={handleChange} name='1' type="radio" value="Employed" />Employed</label>
            <label><input onClick={handleChange} name='1' type="radio" value="Unemployed" />Unemployed</label>
            <label><input onClick={handleChange} name='1' type="radio" value="SelfEmployed" />Self-employed</label>
        </div>
      </form>
